...
def elipsoide (xp,yp,zp,xc,yc,zc,a,b,azimuth,delta,declirem,inclirem,intensity,decT,incT,intT,k):
    ...
    output:
    Bx_P, By_P, Bz_P, Tf_P - componentes of magnetic field generated by an elipsoid and the total-field anomaly.
    '''
...
def m_convP (angles):
    '''
    Builds the matrix of coordinate system change to the center of the elipsoid. Used for the prolate elipsoid.
    ...
    center of the elipsoid. (=90 degrees).
...
def N_desmag (a,b):
    '''
    Calculates the three demagnetization factor along major, intermediate and minor axis. For the prolate elipsoid use.
...
def x_e (xp,yp,zp,center,mcon):
    ...
    xp,yp - Origin of the elipsoid in the geographic coordinate.
    zp - Depth of the the elipsoid.
    center - point in the grid that has the center of the elipsoid.
    mcon - Matrix of conversion.
...
def r_e (x1,x2,x3):
    ...
    Used in the prolate and oblate elipsoids.
...
def dlambx_e (a,b,x1,x2,x3,lamb,r,delta):
    ...
    Used for the prolate elipsoids.
...
def f1_e (a,b,x1,x2,x3,lamb,JRD):
    '''
    Auxiliar calculus of magnetic field generated by a prolate elipsoid.
    ...
    output:
    f1 - Auxiliar calculus of magnetic field generated by a prolate or an oblate elipsoid.
    '''
...
def log_m (a,b,lamb):
    ...
    output:
    log - Auxiliar calculus of magnetic field generated by a prolate elipsoid.
    '''
...
def f2_e (a,b,lamb,log):
    ...
    output:
    f2 - Auxiliar calculus of magnetic field generated by a prolate elipsoid.
    '''
...
def B1_e (dlambx1,JRD,f1,f2,log,a,b,lamb):
    ...
    Used in the prolate elipsoid.
    
    input:
    dlambx1 - Derivative of the elipsoid equation for each body coordinates in realation to x1.
    JRD - Resultant magnetization vector with self-demagnetization correction.
    f1,f2,log - Auxiliar calculus of magnetic field generated by a prolate elipsoid.
    a,b - Major and minor axis, respectively.
    lamb - Larger root of the cartesian elipsoidal equation.
...
def B2_e (dlambx2,JRD,f1,f2):
    ...
    JRD - Resultant magnetization vector with self-demagnetization correction.
    f1,f2 - Auxiliar calculus of magnetic field generated by a prolate elipsoid.

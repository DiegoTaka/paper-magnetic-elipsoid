...
def ellipsoid (xp,yp,zp,xc,yc,zc,a,b,azimuth,delta,declirem,inclirem,intensity,decT,incT,intT,k):
    ...
    angles = np.array([azimuth,delta,0.])
...
def V_e (angles):
    ...
    v1 = np.array([ cos_alpha*cos_gamma*sin_delta + sin_alpha*sin_gamma,
...
def U_e (angles):
    ...
    u1 = np.array([-cos_alpha*cos_delta, 
                   -sin_alpha*cos_delta, 
                   -sin_delta])
    
    u2 = np.array([ cos_alpha*cos_gamma*sin_delta + sin_alpha*sin_gamma,
                    sin_alpha*cos_gamma*sin_delta - cos_alpha*sin_gamma,
                   -cos_gamma*cos_delta])

    u3 = -np.array([ sin_alpha*cos_gamma - cos_alpha*sin_gamma*sin_delta,
                   -cos_alpha*cos_gamma - sin_alpha*sin_gamma*sin_delta,
                    sin_gamma*cos_delta])

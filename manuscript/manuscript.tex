...
The elements of $\tilde{\mathbf{N}}^{\dagger}$ will be 
presented in a latter section.
...
(Eq. \ref{eq:K-isotropic}) and $\chi << 1$, the magnetization
...
FALAR DO CASO EM QUE A INDUCAO EH PARALELA A UM EIXO DO ELIPSOIDE

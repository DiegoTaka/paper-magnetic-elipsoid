...
In this case, the magnetization $\mathbf{M}$ (Eq. \ref{eq:M-KH}),
...
\left[ \begin{array}{ccc}
\frac{1}{1 - \chi \, \tilde{n}^{\dagger}_{11}} &  &  \\
 & \frac{1}{1 - \chi \, \tilde{n}^{\dagger}_{22}} &  \\
 &  & \frac{1}{1 - \chi \, \tilde{n}^{\dagger}_{33}}
\end{array} \right] \mathbf{V}^{\top} \: .
\label{eq:Lambda}
\end{equation}
...
$\mathbf{\Lambda}$ (Eqs. \ref{eq:M-K-isotropic} and \ref{eq:Lambda})
approaches to the identity and the magnetization
$\mathbf{M}$ (Eqs. \ref{eq:M-KH} and \ref{eq:M-K-isotropic})

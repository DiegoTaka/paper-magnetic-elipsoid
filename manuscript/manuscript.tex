...
FALAR QUE ESTA EQUACAO REPRESENTA O CASO HOMOGENEO ANISOTROPICO. 
FALAR QUE A MAIORIA DOS TRABALHOS DISCUTE O CASO HOMOGENEO ISOTROPICO
(CITAR TRABALHOS)
O CASO ANISOTROPICO FOI APRESENTADO PELA PRIMEIRA VEZ POR \citet{soliverez1981} and
posteriorly by \citet{emerson1985} and \citet{clark1986} (CHECAR).


FALAR DO CASO PARTICULAR EM QUE A SUSCETIBILIDADE EH MUITO FRACA E
A REMANENCIA EH NULA. NESTE CASO, A MAGNETIZACAO EH A FORMULA CLASSICA
DE MAGNETIZACAO INDUZIDA ENCONTRADA NOS LIVROS.

FALAR TAMBEM SOBRE O CASO ISOTROPICO E CITAR O TRABALHO DO GUO 2001.
USAR OS TERMOS INTRINSIC E EFFECTIVE MAGNETIZATIONS.

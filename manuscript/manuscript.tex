...
The scalar function $\tilde{f}_{I}(\tilde{\mathbf{r}})$
is given by
\begin{equation}
...
for defining the resultant uniform magnetic field $\tilde{\mathbf{H}}_{I}$
inside the ellipsoidal body as follows:
\begin{equation}
\tilde{\mathbf{H}}_{I} = 
\left( \mathbf{I} - \tilde{\mathbf{N}}_{I} \, \tilde{\mathbf{K}} \right)^{-1}
\tilde{\mathbf{H}}_{0} \: ,
\label{eq:Hi-tilde}
\end{equation}
where $\mathbf{I}$ is the identity matrix and 
$\tilde{\mathbf{N}}_{I}$ represents the
transformed depolarization tensor evaluated within 
the volume $V$ of the ellipsoidal body. The elements
of $\tilde{\mathbf{N}}_{I}$ will be presented in a 
later section.

Let us pre-multiply the uniform internal field $\tilde{\mathbf{H}}_{I}$
...
\tilde{\mathbf{H}}_{0} \\
&=  
\left( \mathbf{I} - \tilde{\mathbf{K}} \, \tilde{\mathbf{N}}_{I} \right)^{-1}
...
\subsection{Transformed depolarization tensor $\tilde{\mathbf{N}}(\tilde{\mathbf{r}})$}

...
\caption{Differences between the total-field 
anomaly obtained by using the approximated magnetization $\breve{\mathbf{M}}$
(Eq. \ref{eq:M-approx}) and that obtained by using the 
...
at the constant vertical coordinate $z = 0$ \unit{m},
for three synthetic bodies.
(a) Differences produced by the synthetic orebody defined in
Tab. \ref{tab:parameters-warrego}.
(b) Differences produced by the synthetic orebody defined in
Tab. \ref{tab:parameters-warrego}, but with an isotropic
susceptibility $\chi = 0.1$ SI.
(c) Differences produced by the synthetic orebody defined in
Tab. \ref{tab:parameters-warrego}, but with an isotropic
susceptibility $\chi = 0.044$ SI. This value was calculated
with Eq. \ref{eq:chi-max}, by using $\epsilon = 2 \%$.}
\label{fig:tfa-warrego}
\end{figure}
...
Isotropic susceptibility $\chi$ & $1.69$ & SI \\

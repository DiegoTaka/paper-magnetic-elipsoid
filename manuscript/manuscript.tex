...
\subsubsection{Relationship between $\chi$ and the magnetization error}
...
\end{equation}
where $\mathbf{M}$ is the true magnetization obtained from Eq. 
\ref{eq:M-K-isotropic-inverse-Lambda} and $\breve{\mathbf{M}}$
is the approximated magnetization obtained from Eq. \ref{eq:M-approx}.

...
The angles refering to the unit vectors are determined by the orientations of the ellipsoid's semi-axis. The angle $\alpha$ is the azimuth of semi-major axe ($a$) plus 180º. Meanwhile $\delta$ is the inclination of semi-major axe ($a$) in relation to the geographic plane. Lastly, $\gamma$ is the angle between the semi-mid axe ($b$) and the vertical projection of the ellipsoid's center with the geographic plane.
